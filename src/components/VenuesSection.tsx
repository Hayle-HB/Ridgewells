      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 clamp(16px, 4vw, 36px)' }}>
        ...
        >
          ...
          <div style={{ padding: 'clamp(24px, 5vw, 64px)' }}>
            ...
            <p style={{ fontSize: '13px', color: '#736D78', marginBottom: '18px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '6px' }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#592367" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
